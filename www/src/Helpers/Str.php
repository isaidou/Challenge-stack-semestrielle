...
class Str
{
	...
	public static function formatCommentCount(int $count): string
	{
		if ($count === 0) return "Pas de commentaires";
	...
	public static function formatArticleViews(int $count): string
	{
		if ($count === 0) return "Pas de vues";
	...
	public static function isValidPseudo(string $name): bool
	{
	...
	{
		$description = self::stripSpaces($description);
		return strlen($description) <= 300 && strlen($description) >= 10;
	}
