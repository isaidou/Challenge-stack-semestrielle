...
class View
{
	public static function header(bool $defaultNav = true, string $title = SITENAME): void
	{
		...
		if ($defaultNav) {
			if (Session::hasRole('admin')) {
				require_once APPROOT . '/Views/inc/admin/navbar.php';
			} else if (Session::hasRole('user')) {
				require_once APPROOT . '/Views/inc/user/navbar.php';
			} else {
	...
	public static function footer(bool $defaultFooter = true): void
	{
		...
		if ($defaultFooter) {
			if (Session::hasRole('admin')) {
				require_once APPROOT . '/Views/inc/admin/footer.php';
			} else if (Session::hasRole('user')) {
				require_once APPROOT . '/Views/inc/user/footer.php';
			} else {
				require_once APPROOT . '/Views/inc/guest/footer.php';
			}
		}
	}
	...
	public static function redirectIfNotAuthorized(string $role, string $redirectUrl): void
	{
